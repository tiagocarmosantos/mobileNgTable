    ...
    app.directive('mobileNgTable', function($filter,$templateCache) {
        ...
        link : function(scope, element, attrs) {
            ...
            if(scope.pager.type == 'local') {
                ...
                scope.$parent.$watch(option.data, function (newdata) { scope.data = newdata; scope.pager.total = newdata.length; }, true);
                scope.pagerReloadClick = option.pagerReloadClick;
            }
            ...
            scope.functionLimitPerPage = function (total, limitPerPage) {
                return (limitPerPage < total ? limitPerPage : total);;
            };
        }
    };
    });
